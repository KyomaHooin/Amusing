;
; Pocernice: Sauter NovaPro 374cz DS -> CSV -> GZ -> HTTP
;
; schtasks /create /tn "Pocernice Amusing" /tr "c:\pocernice-amusing\pocernice-amusing.exe" /sc HOURLY
;
