;
; Comet System DBF -> CSV -> GZ -> HTTP
;
; schtasks /create /tn "Comet Amusing HTTP" /tr "c:\comet-amusing\comet-amusing.exe" /sc HOURLY
;

#AutoIt3Wrapper_Icon=comet.ico
#NoTrayIcon
...
$comet = 'Ms234p.exe'
$comet_location = 'c:\Progra~2\CometLoggers\MSPlus\'
